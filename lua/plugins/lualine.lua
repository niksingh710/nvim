return {
  ...
  config = function()
    ...
    local tcolors = {
      bg = "none", -- Set background to transparent
      fg = "#d2d2d2", -- Set foreground color
      yellow = "#ECBE7B",
      cyan = "#008080",
      darkblue = "#081633",
      green = "#98be65",
    ...
    local function transparent_theme()
      return {
        normal = {
          a = { fg = tcolors.bg, bg = tcolors.blue, gui = "bold" },
          b = { fg = tcolors.fg, bg = tcolors.darkblue },
          c = { fg = tcolors.fg, bg = tcolors.bg },
        },
        insert = {
          a = { fg = tcolors.bg, bg = tcolors.green, gui = "bold" },
          b = { fg = tcolors.fg, bg = tcolors.darkblue },
          c = { fg = tcolors.fg, bg = tcolors.bg },
        },
        visual = {
          a = { fg = tcolors.bg, bg = tcolors.magenta, gui = "bold" },
          b = { fg = tcolors.fg, bg = tcolors.darkblue },
          c = { fg = tcolors.fg, bg = tcolors.bg },
        },
        replace = {
          a = { fg = tcolors.bg, bg = tcolors.red, gui = "bold" },
          b = { fg = tcolors.fg, bg = tcolors.darkblue },
          c = { fg = tcolors.fg, bg = tcolors.bg },
        },
        command = {
          a = { fg = tcolors.bg, bg = tcolors.orange, gui = "bold" },
          b = { fg = tcolors.fg, bg = tcolors.darkblue },
          c = { fg = tcolors.fg, bg = tcolors.bg },
        },
        inactive = {
          a = { fg = tcolors.fg, bg = tcolors.bg, gui = "bold" },
          b = { fg = tcolors.fg, bg = tcolors.bg },
          c = { fg = tcolors.fg, bg = tcolors.bg },
        },
      }
    end
