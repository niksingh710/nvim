...
return {
...

	{
		...
		config = function()
			...
			utils.map("n", {
				["<leader>D"] = { "<cmd>Copilot disable<cr>", "Copilot Disable" },
			})
		end,
	},
	{
	...
	},
	{
		...
		config = function()
			...
			utils.map("n", { ["<leader>mb"] = { "<cmd>MarkdownPreview<cr>", "Browser" } })
		end,
	},
	{
		"j-hui/fidget.nvim",
	...
	"gpanders/nvim-parinfer", -- for yuck eww
	"elkowar/yuck.vim", -- filetype support
}
